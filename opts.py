...
def parse_opts():
    ...
    parser.add_argument('--video_root', default='videos/tvsum/video', type=str, help='Root path of input videos')
    parser.add_argument('--annotation_path', default='videos/tvsum/data/ydata-tvsum50-anno.tsv', type=str, help='Root path of input videos')
    parser.add_argument('--model', default='resnext-101-kinetics.pth', type=str, help='Model file path')
